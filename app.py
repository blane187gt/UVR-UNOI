...
with gr.Blocks(theme="Blane187/fuchsia", title="🎵 UVR5 UI 🎵") as app:

    gr.Markdown("<h1> 🎵 UVR5 UI Mode 🎵 </h1>")

    gr.Markdown("If you like UVR5 UI you can star repo on [GitHub](https://github.com/Eddycrack864/UVR5-UI)")
